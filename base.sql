...
CREATE TABLE `solicitud` (
  ...
  CONSTRAINT `fk_solicitud_comanda` FOREIGN KEY (`fecha_comanda`, `mesa_comanda`) REFERENCES `comanda` (`fecha`, `mesa`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-01 15:47:26
